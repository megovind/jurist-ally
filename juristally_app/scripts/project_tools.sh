...
function cleanup() {
    ...
    rm -rf android build *.iml ios pubspec.lock test .flutter-plugins .metadata .packages .idea ios web
}

function create() {
    cd $FLUTTER_APP_FOLDER
    if [ ! -d "ios" ] && [ ! -d "android" ] && [ ! -d "ios" ]; then
...
function add_permission_label() {
    ...
    echo "Add permission labels to ios."
    echo ""
    python add-line.py -i ../ios/Runner/Info.plist -s '<key>CFBundleShortVersionString</key>' -t '	<key>NSCameraUsageDescription</key>'
    python add-line.py -i ../ios/Runner/Info.plist -s '<key>CFBundleShortVersionString</key>' -t '	<string>$(PRODUCT_NAME) Camera Usage!</string>'
    python add-line.py -i ../ios/Runner/Info.plist -s '<key>CFBundleShortVersionString</key>' -t '	<key>NSMicrophoneUsageDescription</key>'
    python add-line.py -i ../ios/Runner/Info.plist -s '<key>CFBundleShortVersionString</key>' -t '	<string>$(PRODUCT_NAME) Microphone Usage!</string>'
    
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <key>com.apple.security.device.camera</key>'
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <true/>'
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <key>com.apple.security.device.microphone</key>'
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <true/>'
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <key>com.apple.security.network.client</key>'
    python add-line.py -i ../ios/Runner/DebugProfile.entitlements -s '</dict>' -t '       <true/>'
    
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <key>com.apple.security.device.camera</key>'
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <true/>'
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <key>com.apple.security.device.microphone</key>'
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <true/>'
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <key>com.apple.security.network.client</key>'
    python add-line.py -i ../ios/Runner/Release.entitlements -s '</dict>' -t '       <true/>'
}
